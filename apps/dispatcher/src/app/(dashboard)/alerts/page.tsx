  ...
  return (
    <main className="p-8">
      ...
      <p className="text-sm text-slate-500 mt-1">
        System notifications and incident escalations
      </p>
      <div className="mt-8 bg-white rounded-card p-12 border border-slate-100 text-center">
        ...
        <p className="text-sm text-slate-500 max-w-md mx-auto">
          The alerts inbox lands in a later module — driver no-shows, SLA
          breaches, ambulance breakdowns, and other operational escalations
          will surface here.
        </p>
      </div>
    </main>
